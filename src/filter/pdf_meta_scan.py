...
from src.config.drop_reason import DropReason
from src.libs.commons import get_top_percent_list, mymax
from src.libs.language import detect_lang
from src.libs.pdf_check import detect_invalid_chars_by_pymupdf, detect_invalid_chars
