...
from src.libs.commons import parse_bucket_key

# 定义配置文件名常量
#CONFIG_FILE_NAME = os.getenv('MINERU_TOOLS_CONFIG_JSON', 'config.json')

current_script_path = os.path.abspath(__file__)
# 获取当前脚本所在目录（即脚本文件的父目录）
current_dir = os.path.dirname(current_script_path)
CONFIG_FILE_NAME = os.path.join(os.path.dirname(os.path.dirname(current_dir)),'config.json')
