...
from src.model.sub_modules.table.rapidtable.rapid_table import RapidTableModel
# try:
...
#     from src.model.sub_modules.ocr.paddleocr.ppocr_273_mod import ModifiedPaddleOCR
#     # from src.model.sub_modules.ocr.paddleocr.ppocr_291_mod import ModifiedPaddleOCR
#     from src.model.sub_modules.table.rapidtable.rapid_table import RapidTableModel


def table_model_init(table_model_type, model_path, max_time, _device_='cpu', lang=None, table_sub_model_name=None):
    if table_model_type == MODEL_NAME.STRUCT_EQTABLE:
        from src.model.sub_modules.table.structeqtable.struct_eqtable import StructTableModel
        table_model = StructTableModel(model_path, max_new_tokens=2048, max_time=max_time)
    elif table_model_type == MODEL_NAME.TABLE_MASTER:
        from src.model.sub_modules.table.tablemaster.tablemaster_paddle import TableMasterPaddleModel
        config = {
...
def layout_model_init(weight, config_file, device):
    from src.model.sub_modules.layout.layoutlmv3.model_init import Layoutlmv3_Predictor
