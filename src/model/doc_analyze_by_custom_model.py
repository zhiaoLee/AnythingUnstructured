...
from src.model.sub_modules.model_utils import get_vram
from src.config.enums import SupportedPdfParseMethod
import src.model as model_config
from src.data.dataset import Dataset
from src.libs.clean_memory import clean_memory
from src.libs.config_reader import (get_device, get_formula_config,
                                    get_layout_config,
                                    get_local_models_dir,
                                    get_table_recog_config)
from src.model.model_list import MODEL
...
def custom_model_init(
    ...
    if model_config.__use_inside_model__:
        ...
        if model == MODEL.Paddle:
            from src.model.pp_structure_v2 import CustomPaddleModel

            custom_model = CustomPaddleModel(ocr=ocr, show_log=show_log, lang=lang)
        elif model == MODEL.PEK:
            from src.model.pdf_extract_kit import CustomPEKModel
...
def doc_analyze(
    ...
    from src.operators.models import InferenceResult
    ##
...
def may_batch_image_analyze(
    ...
    from src.model.batch_analyze import BatchAnalyze
